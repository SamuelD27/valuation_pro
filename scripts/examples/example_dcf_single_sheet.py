"""
Example: Generate Single-Sheet DCF Model

Demonstrates how to create a single-sheet DCF model for easier navigation.
"""
...
def main():
    """Generate example single-sheet DCF model."""
    ...
    # Create single-sheet DCF model
    dcf = DCFToolSingleSheet(
    ...
    # Generate single-sheet DCF model
    dcf.generate_dcf_model(
        historical_data=historical_data,
        assumptions=assumptions,
        output_file='Examples/DCF_Model_AcmeTech_SingleSheet.xlsx'
    )

    print("\n✅ Single-sheet DCF model generated successfully!")
    print("📄 File: Examples/DCF_Model_AcmeTech_SingleSheet.xlsx")
    print("\n📊 Model includes:")
    print("   - Cover section")
    print("   - Assumptions")
